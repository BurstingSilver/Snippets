...
IF NOT EXISTS(SELECT * FROM UD_FIELD WHERE TABLE_NAME = 'UD_TABLE' AND FIELD_NAME = 'VC_FIELD')
...
IF NOT EXISTS(SELECT * FROM UD_FIELD WHERE TABLE_NAME = 'UD_TABLE' AND FIELD_NAME = 'BIT_FIELD')
	INSERT INTO UD_Field (TABLE_NAME, FIELD_NAME, FIELD_TYPE, FIELD_LENGTH, PROMPT, SEQ, OBJ_HEIGHT, OBJ_WIDTH) 
...
IF NOT EXISTS(SELECT * FROM UD_FIELD WHERE TABLE_NAME = 'UD_TABLE' AND FIELD_NAME = 'DT_FIELD')
	INSERT INTO UD_Field (TABLE_NAME, FIELD_NAME, FIELD_TYPE, FIELD_LENGTH, PROMPT, SEQ, OBJ_HEIGHT, OBJ_WIDTH) 
...
IF NOT EXISTS(SELECT * FROM UD_FIELD WHERE TABLE_NAME = 'UD_TABLE' AND FIELD_NAME = 'INT_FIELD')
	INSERT INTO UD_Field (TABLE_NAME, FIELD_NAME, FIELD_TYPE, FIELD_LENGTH, PROMPT, SEQ, OBJ_HEIGHT, OBJ_WIDTH) 
...
IF NOT EXISTS(SELECT * FROM UD_FIELD WHERE TABLE_NAME = 'UD_TABLE' AND FIELD_NAME = 'MONEY_FIELD')
	INSERT INTO UD_Field (TABLE_NAME, FIELD_NAME, FIELD_TYPE, FIELD_LENGTH, PROMPT, SEQ, OBJ_HEIGHT, OBJ_WIDTH) 
